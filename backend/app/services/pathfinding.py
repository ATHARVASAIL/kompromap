...
# Anything at or above this is a route through an excluded finding.
# Half of IMPASSABLE so a chain of several genuine edges can never reach it.
IMPASSABLE_THRESHOLD = IMPASSABLE / 2
